...
public class TestAtLeastOneMoveExists {
    ...
    public void testEmptySpace() {
        ...
        System.out.println(rawVals[0][1]);
        System.out.println(rawVals[1][1]);
        System.out.println(rawVals[2][1]);
        System.out.println(rawVals[3][1]);
    ...
    public void testAnyDir() {
        ...
        System.out.println(rawVals[0][2]);
        System.out.println(rawVals[0][3]);
        System.out.println(rawVals[2][1]);
        System.out.println(rawVals[3][1]);
        b = new Board(rawVals, 0);
        assertTrue("A tilt in any direction will change the board\n"
